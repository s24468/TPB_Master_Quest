...
public class CreatureAttackCommand : Command 
{
    ...
    private string AttackerUniqueID;
    ...
    public CreatureAttackCommand(int targetID, string attackerID, int damageTakenByAttacker, int damageTakenByTarget, int attackerHealthAfter, int targetHealthAfter)
    {
    ...
    {
        GameObject Attacker = Services.Get<IInstanceIdService>().Find(AttackerUniqueID);
